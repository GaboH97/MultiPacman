...
public class FrameGame extends javax.swing.JFrame {
    ...
    public FrameGame(ControllerClient controlerClient) {
        this.controllerClient = controlerClient;
        initComponents();
        panelsito = new PanelGame1(controlerClient);
        this.add(panelsito);
        threadRepaint(this);
        this.addKeyListener(controlerClient);
    }
    ...
    public void threadRepaint(FrameGame frameGame) {
